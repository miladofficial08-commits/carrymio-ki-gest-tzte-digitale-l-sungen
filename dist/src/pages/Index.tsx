          ...
          <div className="container px-4 relative z-10">
            ...
            <StaggerContainer staggerDelay={0.12} className="mt-14 mx-auto max-w-6xl grid items-stretch gap-5 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <StaggerItem>
                ...
                >
                  <div className="flex items-center gap-3">
                    <span className="rounded-xl border border-primary/20 bg-primary/8 p-2">
                  ...
                  <ul className="mt-4 space-y-2 text-sm text-foreground/90">
                    {["Supportanfragen automatisch beantworten", "Kundenabsichten in Sekunden erkennen", "Leads sammeln und qualifizieren", "In bestehende Systeme integrieren", "Supportaufwand erheblich reduzieren"].map((feat) => (
              ...
              <StaggerItem>
                ...
                >
                  ...
                  <ul className="mt-4 space-y-2 text-sm text-foreground/90">
                    {["Unternehmenswebseiten & Landing Pages", "Hochwertiges Design und klare Struktur", "Moderne Animationen und visuelle Elemente", "Optimiert für Conversion und Leadgenerierung", "Schnell, performant und mobiloptimiert"].map((feat) => (
                      <li key={feat} className="flex items-start gap-2">
                        <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0 text-primary" aria-hidden="true" />
                        {feat}
                      </li>
              ...
              <StaggerItem>
                ...
                <motion.article
                  ...
                  transition={{ type: "spring", stiffness: 300, damping: 20 }}
                  className="premium-panel relative flex h-full flex-col p-6 ring-2 ring-primary/30 shadow-xl shadow-primary/8 overflow-hidden"
                >
                  ...
                  <motion.div
                    ...
                    style={{ boxShadow: "inset 0 0 0 1.5px hsl(217 91% 60% / 0.35)" }}
                  />
                  <div className="relative z-10 flex flex-col h-full">
                    <div className="flex items-center justify-between gap-3">
                      <div className="flex items-center gap-3">
                        <span className="rounded-xl border border-primary/30 bg-primary/12 p-2.5">
                    ...
                    <motion.div
                      ...
                      className="mt-3 inline-flex items-center gap-1.5 rounded-full border border-primary/30 bg-primary/10 px-3 py-1"
                    >
                      <Sparkles className="h-3 w-3 text-primary" aria-hidden="true" />
                      <span className="text-[11px] font-semibold uppercase tracking-[0.1em] text-primary">Beliebteste Lösung</span>
                    </motion.div>
                    <ul className="mt-4 space-y-2 text-sm text-foreground/90">
                      {["Support-Anfragen und Leads automatisch erkennen", "E-Mails automatisch beantworten", "Bis zu 7 Sprachen", "Frühere Gespräche merken (Memory)", "Lernsystem zur Selbstverbesserung", "Fehler erkennen und korrigieren"].map((feat) => (
                        <li key={feat} className="flex items-start gap-2">
                          <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0 text-primary" aria-hidden="true" />
                          {feat}
                        </li>
                    ...
                    <p className="mt-auto pt-4 text-xs text-primary/70 font-medium">Unverbindliches Angebot</p>
                    <Button
                      variant="hero"
                      size="sm"
                      className="mt-3 w-full"
                      onClick={() => navigate("/digitale-mitarbeiter")}
                    >
              ...
              <StaggerItem>
                ...
                >
                  ...
                  <Button
                    ...
                    size="sm"
                    className="mt-3 w-full"
                    onClick={() => navigate("/custom-automation")}
                  >
                    Anfrage starten
                    <ArrowRight className="ml-1.5 h-3.5 w-3.5" />
                  </Button>
